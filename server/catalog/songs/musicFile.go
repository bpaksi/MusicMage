...
// OpenMusicFile ...
func OpenMusicFile(fullPathName string) (musicFile *MusicFile, err error) {
	musicFile = &MusicFile{}
	musicFile.FullPath = fullPathName

	var id3File *id3.File
	id3File, err = id3.Open(fullPathName)
	if err == nil {
...
// SetAttributes ...
func (musicFile *MusicFile) SetAttributes(artist, album, title, genre, year string) (err error) {
	var id3File *id3.File
